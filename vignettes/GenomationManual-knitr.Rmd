---
title: genomation <br/> a toolkit for annotation and visualization of genomic data
output:
...
<img style="float: right;padding-left:9px" src="Figures/genomationFlowChart1.png", width=350>
...
```{r genomationDataLoad, eval=FALSE}
library(devtools)
...
```{r genomationInfo, eval=TRUE, tidy=TRUE}
library(genomation)
data(cage)
data(cpgi)
...
###Extration of data over genomic winows
...
```
<div>
  <img src="Figures/heatMatrix1-1.png", width=400>
  <img src="Figures/heatMatrix1-2.png", width=400>
</div>
...
```
<img align="midle" src="Figures/heatMatrix2-1.png", width=350>
...
```
<img align="midle" src="Figures/heatMatrixScales-1.png", width=350>
...
```
<img align="midle" src="Figures/multiHeatMatrix1-1.png", width=350>
...
```
<img align="midle" src="Figures/multiHeatMatrix2-1.png", width=350>
...
```{r etFiles_annotation, eval=TRUE, tidy=TRUE}
library(genomationData)
...
```{r plotGeneAnnotation, eval=TRUE, tidy=TRUE, dpi=300, out.width='.25\\textwidth', include=FALSE}
plotGeneAnnotation(annot.list)
plotGeneAnnotation(annot.list, cluster=TRUE)
```
<img align="midle" src="Figures/plotGeneAnnotation-1.png", width=350>
<img align="midle" src="Figures/plotGeneAnnotation-2.png", width=350>
...
```{r ctcfScoreMatrixList, eval=TRUE, tidy=TRUE, fig.width=5, fig.height=3.5, dpi=300, include=FALSE}
...
```
<img align="midle" src="Figures/ctcfScoreMatrixList-1.png", width=350>
<caption>Heatmap profile of unscaled coverage shows a slight colocalization of
         Ctcf, Rad21 and Znf143. </caption>
...
```{r plotScaledProfile, eval=TRUE, tidy=TRUE, fig.width=5, fig.height=3.5, dpi=300, include=FALSE}
  sml.scaled = scaleScoreMatrixList(sml)
multiHeatMatrix(sml.scaled, xcoords=c(-500, 500), col=c('lightgray', 'blue'))
```
<img align="midle" src="Figures/plotScaledProfile-1.png", width=350>
<caption>Heatmap profile of scaled coverage shows much stronger colocalization 
         ...
         peaks have a very weak enrichment.</caption>
...
```{r visualizeFeatureComb, eval=TRUE, tidy=TRUE, fig.width=5, fig.height=3, dpi=300, include=FALSE}
...
multiHeatMatrix(sml.scaled, xcoords=c(-500, 500), col=c('lightgray', 'blue'))
```
<img align="midle" src="Figures/visualizeFeatureComb-1.png", width=350>
