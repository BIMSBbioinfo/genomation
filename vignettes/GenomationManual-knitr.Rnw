...
\textcolor{white}{write something here}
...
<<genomationInfo, eval=TRUE, tidy=TRUE>>=
library(genomation)
data(cage)
data(cpgi)
...
@
\includegraphics[width=0.4\textwidth]{Figures/FiguresheatMatrix11.pdf}
\includegraphics[width=0.4\textwidth]{Figures/FiguresheatMatrix12.pdf}
...
@
\includegraphics[width=0.5\textwidth]{Figures/FiguresheatMatrix2.pdf}
...
@
\includegraphics[width=0.5\textwidth]{Figures/FiguresheatMatrixScales.pdf}
...
@
\includegraphics[width=0.5\textwidth]{Figures/FiguresmultiHeatMatrix1.pdf}
...
@
\includegraphics[width=0.5\textwidth]{Figures/FiguresmultiHeatMatrix2.pdf}
...
@
\includegraphics[width=0.3\textwidth]{Figures/FiguresplotGeneAnnotation1.pdf}
\includegraphics[width=0.3\textwidth]{Figures/FiguresplotGeneAnnotation2.pdf}
...
@
\includegraphics[width=0.65\textwidth]{Figures/FiguresctcfScoreMatrixList.pdf}
...
@
\includegraphics[width=0.65\textwidth]{Figures/FiguresplotScaledProfile.pdf}
...
multiHeatMatrix(sml.scaled, xcoords=c(-500, 500), col=c('lightgray', 'blue'))
@
\includegraphics[width=0.65\textwidth]{Figures/FiguresvisualizeFeatureComb.pdf}
