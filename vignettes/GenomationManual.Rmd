...
In the example below, *ScoreMatrixBin* function calculates coverage on exons, 
stiches exons of each transcript together, bins them into 50 bins and 
...
sm = ScoreMatrixBin(target=target.rle, windows=transcripts, bin.num=50)
```
