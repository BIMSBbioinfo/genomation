...
{\centering \includegraphics[width=.49\linewidth]{inst/doc/FiguresmultiHeatMatrix1} 
...
{\centering \includegraphics[width=.8\linewidth]{inst/doc/FiguresctcfScoreMatrixList} 
...
{\centering \includegraphics[width=.8\linewidth]{inst/doc/FiguresvisualizeFeatureComb} 
